  ...
  execFileSync(
    ...
    [
      ...
      [
        ...
        "}",
        "const shadow = api.createShadowAccount({ config: {",
        '  accountAddress: "0x1", accountPrivateKey: "0x2", viewingKey: 3n,',
        '  rpcUrl: "https://rpc.example", poolAddress: "0x4", tokenAddress: "0x5",',
        '  anonymizerAddress: "0x6", proverUrl: "https://prover.example", proverApiKey: "prover-test",',
        '  discoveryUrl: "https://discovery.example", paymasterUrl: "https://paymaster.example",',
        '  paymasterApiKey: "test", appName: "smoke", nonce: 0n, maxPaymasterFee: 1n,',
        "} });",
